...
def generate_average_speed_result(vehicle_count, speed_ranges):
    smarts_cars_average_speed_df = pd.read_csv(f'data/smarts/cars_speed_{vehicle_count}', delimiter=',')
    smarts_bikes_average_speed_df = pd.read_csv(f'data/smarts/bikes_speed_{vehicle_count}', delimiter=',')
    sumo_cars_average_speed_df = pd.read_csv(f'data/sumo/cars_speed_{vehicle_count}', delimiter=',')
    sumo_bikes_average_speed_df = pd.read_csv(f'data/sumo/bikes_speed_{vehicle_count}', delimiter=',')
...
def generate_vehicles_count_in_area_result(vehicle_count):
    smarts_vehicle_count_in_area_df = pd.read_csv(f'data/smarts/area_{vehicle_count}', delimiter=',')
    sumo_vehicle_count_in_area_df = pd.read_csv(f'data/sumo/area_{vehicle_count}', delimiter=',')
